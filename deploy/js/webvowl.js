...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function ( graphContainerSelector ){
	  ...
	  function createNewObjectProperty( domain, range, draggerEndposition ){
	    ...
	    if(selected_object_type == 'subclass-of' || selected_object_type == 'instance-of'){
	      defaultPropertyName = "rdfs:subclassof";
	    }
	    ...
	    if(selected_object_type){
	      ...
	      if(defaultPropertyName == 'rdfs:subClassOf' || (selected_object_type == 'subclass-of' || selected_object_type == 'instance-of')){
